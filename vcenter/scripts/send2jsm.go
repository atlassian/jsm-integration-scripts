...
func configureLogger() log.Logger {
	...
	if len(logFilePath) == 0 {
		logFilePath = "C:/jsm/vcenter2jsm.log"
	}
...
func getHttpClient(timeout int) *http.Client {
	...
	var proxyPort = configParameters["vcenter2jsm.http.proxy.port"]
	var scheme = configParameters["vcenter2jsm.http.proxy.protocol"]
	var proxyUsername = configParameters["vcenter2jsm.http.proxy.username"]
	var proxyPassword = configParameters["vcenter2jsm.http.proxy.password"]
...
func http_post() {
	...
	apiUrl := configParameters["jsm.api.url"] + "/jsm/ops/integration/v1/json/vcenter"
