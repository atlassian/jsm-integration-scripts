...
func main() {
	...
	if *version != "" {
		fmt.Println("Jira Service Management - BMC FootPrints v11 Integration Package 1.0")
		return
	}
	...
	parameters["jsmAlertAlias"] = issueDetails.JSMAlertAlias
...
func configureLogger() log.Logger {
	...
	if len(logFilePath) == 0 {
		if runtime.GOOS == "windows" {
			logFilePath = "C:\\jsm\\jec\\bmcfootprintsv11\\send2jsm.log"
		} else {
...
func postToJSM() {
	apiUrl := configParameters["jsm.api.url"] + "/jsm/ops/integration/v1/json/bmcfootprintsv11"
