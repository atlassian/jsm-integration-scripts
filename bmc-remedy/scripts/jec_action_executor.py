...
def main():
    ...
    if mapped_action == 'addWorkInfo':
        add_work_info('SOAP-JSM [Add Work Info]', username, password, incident_number,
                      work_info_details, midtier_server_url, server_name)
    elif mapped_action == 'createIncident':
        create_incident('SOAP-JSM [Create Incident]', alert_id, username, password, company, customer_name,
        ...
        close_incident('SOAP-JSM [Close Incident]', username, password, company, impact, incident_number,
